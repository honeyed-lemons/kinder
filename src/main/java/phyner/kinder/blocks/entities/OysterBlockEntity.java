...
public class OysterBlockEntity extends AbstractIncubatingBlockEntity {
    ...
    public OysterBlockEntity(BlockPos pos,BlockState state){
        super(KinderBlocks.OYSTER_BLOCK_ENTITY,
                pos,
                state);
    }
    @Override
    ...
    public static void tick(World world,BlockPos pos,BlockState state,OysterBlockEntity blockEntity){
        ...
        {
            if (ticksElapsed >= (24000 / (getDownfall(world,pos) + 0.5)))
            {
    ...
    public ArrayList<Item> genPearlSet(int pearlSet) {
        ...
        switch (pearlSet) {
            case 4 -> pearls.addAll(Arrays.asList(KinderItems.PEARL_GEM_0,
                    KinderItems.PEARL_GEM_14,
                    KinderItems.PEARL_GEM_2,
                    KinderItems.PEARL_GEM_6));
            case 3 -> pearls.addAll(Arrays.asList(KinderItems.PEARL_GEM_1,
                    KinderItems.PEARL_GEM_2,
                    KinderItems.PEARL_GEM_7,
                    KinderItems.PEARL_GEM_8));
            case 2 -> pearls.addAll(Arrays.asList(KinderItems.PEARL_GEM_4,
                    KinderItems.PEARL_GEM_5,
                    KinderItems.PEARL_GEM_13,
                    KinderItems.PEARL_GEM_3));
            case 1 -> pearls.addAll(Arrays.asList(KinderItems.PEARL_GEM_11,
                    KinderItems.PEARL_GEM_9,
                    KinderItems.PEARL_GEM_15,
                    KinderItems.PEARL_GEM_10));
        }
