...
public abstract class AbstractIncubatingBlockEntity extends BlockEntity {
    ...
    public static float getDownfall(World world, BlockPos blockPos)
    {
        ...
        switch (biomeName)
        {
            case "minecraft:warm_ocean","minecraft:lukewarm_ocean","minecraft:deep_lukewarm_ocean","minecraft:deep_ocean","minecraft:ocean","minecraft:cold_ocean","minecraft:deep_cold_ocean","minecraft:frozen_ocean","minecraft:deep_frozen_ocean","minecraft:river","minecraft:frozen_river" -> downfall = 1.2f;
        }
        return downfall;
    }
}
