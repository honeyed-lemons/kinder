...
public class KinderItemGroups {
    private static final ItemGroup GEM_GROUP = FabricItemGroup.builder().icon(() -> new ItemStack(KinderItems.RUBY_GEM)).displayName(Text.translatable("itemGroup.kinder.gem_group")).entries((context, entries) -> {
    ...
    private static final ItemGroup MISC_GROUP = FabricItemGroup.builder().icon(() -> new ItemStack(KinderBlocks.INCUBATOR_BLOCK.asItem())).displayName(Text.translatable("itemGroup.kinder.misc_group")).entries((context, entries) -> {
        ...
        entries.add(KinderItems.WHITE_ESSENCE_BOTTLE);
        entries.add(KinderItems.YELLOW_ESSENCE_BOTTLE);
        entries.add(KinderItems.BLUE_ESSENCE_BOTTLE);
        entries.add(KinderItems.PINK_ESSENCE_BOTTLE);
        entries.add(KinderItems.WHITE_ESSENCE_BUCKET);
        entries.add(KinderItems.YELLOW_ESSENCE_BUCKET);
        entries.add(KinderItems.BLUE_ESSENCE_BUCKET);
        entries.add(KinderItems.PINK_ESSENCE_BUCKET);
